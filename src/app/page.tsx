    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <div className="text-center sm:text-right">
              <a
                ...
                className="inline-flex items-center justify-center text-green-400 hover:text-green-300 transition-colors"
              ...
              <button
                ...
                className="text-sm text-gray-400 hover:text-gray-300 transition-colors mt-2 block"
              >
                Terms & Privacy
              </button>
            </div>
      ...
      {showTerms && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 animate-[fadeIn_200ms_ease-out]">
          <div className="bg-white rounded-xl max-w-lg w-full max-h-[85vh] overflow-y-auto shadow-2xl animate-[scaleIn_200ms_ease-out]">
            <div className="sticky top-0 bg-white border-b px-6 py-4 flex items-center justify-between">
              <h2 className="text-lg font-bold text-gray-800">Terms & Privacy</h2>
            ...
            <div className="px-6 py-4 text-sm text-gray-700 space-y-4 leading-relaxed">
              ...
              <section>
                ...
                <p>Prepared in a clean, hygienic kitchen. Please mention allergies in special instructions.</p>
              </section>
              <section>
                <h3 className="font-bold text-gray-800 mb-1">Privacy</h3>
                <p>We collect your name, email (via Google), phone, and address for order fulfillment only. We do not sell, share, or use your data for marketing. Your data is stored securely with row-level access control.</p>
              </section>
              <section>
